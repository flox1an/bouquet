...
import { Clipboard, AlertTriangle, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from 'lucide-react';
...
const BlobList = ({ blobs, title, className = '' }: BlobListProps) => {
